...
echo "deb https://mirror.sg.gs/debian/ trixie main" | sudo tee /etc/apt/sources.list.d/nala-trixie.list > /dev/null

# Use tee -a (append) to add the second mirror
echo "deb https://mirror.twds.com.tw/debian/ trixie main" | sudo tee -a /etc/apt/sources.list.d/nala-trixie.list > /dev/null
